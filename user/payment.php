...
?>
		...
		<div class ="col-sm-6">	
			...
			<div class="col-sm-8">
			<input type ="text" class="form-control" id ="an" name ="an" value="" placeholder ="Enter account number..." /><br/>
			</div>
			</div>
			...
			<div class="col-sm-8">
			<input type ="text" class="form-control" id ="bname" name ="bname"  value=""  placeholder ="Enter bank name..."/><br/>
			</div>
			</div>
...
$sql = "INSERT INTO payment (ORDER_CODE,ACCOUNTNO ,BANK_NAME,ORDER_PRICE,UNAME,UID) Values ('$pcode', '$an','$bn','$price','$uname','$ucode')";
