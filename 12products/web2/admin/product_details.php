...
<div class="header">
		   <div class="col-sm-8 header-left">
					 <div class="logo">
						<a href="index.html"><img src="imagess/logo2.png" alt="" width="100px" height ="50px"/></a>
					 </div>
					 <div class="menu">
...
<div class ="col-sm-2">
 ...
 <p style="color:green; "><?php echo "Welcome User :  ".$_SESSION["USER"];  ?> 	  </p> <br>
 <p style="color:green; "> <?php //echo "Code   ".$_SESSION["USERID"];  ?> 	  
  </ul>
		</div>
		</div>		</div>
		<p>-------------------------------------------------------------------------------------------------------------------------------------</p>
		...
		<div class ="vertical_tabs" style ="background-color:lightyellow">
				<ul class="nav nav-tabs nav-stacked" >
						...
						<li><a href="products_form.php">Products Form</a></li>
						<li class="active"><a href="product_details.php">Product Details</a></li>
						<li><a href="approve_user.php">Approve User</a></li>
						<!--<li><a href="brands_form.php">Brands Form</a></li>
						<li><a href="brands_details.php">Brands Details</a></li>-->
   ...
   <thead>
	<th>SN</th><th>Product Id</th><th >Product Name</th><th>Product Description</th><th >Selling Price</th><th>Offer Price</th><th> Image</th><th> Delete</th>
		</thead>
   <?php
...
//if(	mysqli_num_rows>0)
{
	while ($row=mysqli_fetch_assoc($retval))
	{
		...
		$brands=$row['Brands']; //echo $brands;
		$sp =$row['Selling_Price'];
		$offer=$row['Offer_Price'];
		$images=$row['Images'];
		$pcodee = substr ( $pcode ,2);// echo $pcodee;
		
       if ($pcodee <100 ) $str = "CARS";
	   else  if (($pcodee >100) && ($pcodee <200)) $str = "WATCHES";
	   else  if (($pcodee >200) && ($pcodee <300)) $str = "BIKES";
	   else  if (($pcodee >300) && ($pcodee <400)) $str = "SHOES";
	   else  if (($pcodee >400) && ($pcodee <500)) $str = "SHIRTS";
?>

<tr><td><b><?php echo $i;?></b></td>
<td><?php echo $pcode;?></td><td><b><?php echo $pname;?></b><br><?php echo $brands;?></td><td><b><?php echo $str;?><b></td>
<td><b><?php echo $sp;?></b></td>
<td><b><?php echo $offer;?></b></td></br>
<td>  <img src="imagess/<?php echo $images;?>" class="img-responsive" alt="" width="300px"/><br><b><?php echo $images;?></td>
<td><button style ="background-color:lightgreen"><a href="delete.php?sid=<?php echo $i;?>&a=1">REMOVE</a><button></td>
