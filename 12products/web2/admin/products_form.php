 ...
 <p style="color:green; "> <?php //echo "Code   ".$_SESSION["USERID"];  ?> 	  
		...
		<div class ="vertical_tabs" style ="background-color:lightyellow">
				<ul class="nav nav-tabs nav-stacked" >
						...
						<li class="active"><a href="products_form.php">Products Form</a></li>
	  ...
	  <!------------------------------------------------------------------------------------------->
		...
		<div class ="col-sm-6">	
			...
			<div class="col-sm-8">
			<input type ="text" class="form-control" id ="pid" name ="pid" placeholder ="Enter Product id..." /><br/>
			</div>
			</div>
			...
			<div class="col-sm-8">
			<input type ="text" class="form-control" id ="pname" name ="pname" placeholder ="Enter product name..."/><br/>
			</div>
			</div>
			...
			<div class="col-sm-8">
			<input type ="text" class="form-control" name="brands"   id = "brands" placeholder ="Enter Product Description..."></textarea><br />	
			</div>
			</div>
			...
			<div class="col-sm-8">
			<input type="number" name="sp" class="form-control"  id = "sp" placeholder ="Enter selling price ..."/><br />	
			</div>
			</div>
			
			<div class="form-group">
			<label class="control-label col-sm-4">Offer Price </label> 
			<div class="col-sm-8">
			<input type="number" name="offer" class="form-control"  id = "offer" placeholder ="Enter offer price ..."/><br />	
			</div>
			</div>
...
<img src ="imagess/<?php echo $image;?>"  style=" max-width: 300px;height:300px;"  >
<?php
...
$sql = "INSERT INTO products (Product_Code,Product_Name,Brands,Selling_Price,Offer_Price,Images) Values ( '$pid','$pn','$brands','$sp','$offer','$imagess')";
