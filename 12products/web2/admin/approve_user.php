...
<th>SN</th><th>User Code</th><th>User Name</th><th>User Password</th><th>User Status</th><th>User Status-Approve</th><th>User Status-Reject</th>
<?php 
		...
		while($row = mysqli_fetch_assoc($retval))
		  ...
		  ?> 
				<tr>
                    ...
                    <td><?php echo $p; ?></td>
					<td><?php echo $s; ?></td>
					<td><a href="approve_user1.php?sid=<?php echo $i;?>&a=1">APPROVE  THE USER</a> <br>			
				</td><td>		<a href="approve_user1.php?sid=<?php echo $i;?>&a=2">REJECT  THE USER</a> <br>
					</td>
                 </tr>		
