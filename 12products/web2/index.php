...
<div class="header">
		   <div class="col-sm-8 header-left">
	            ...
	            <div class="col-sm-4 header_right">
					  ...
					  <a href="login/user_login.php" id="loginButton"><img src="images/login.png"><span>LOGINN</span></a>
					  <a href="login/user_login_signup.php" id="loginButton"><img src="images/login.png"><span>SIGNUP</span></a>
					  <a href="login/admin_login.php" id="loginButton"><img src="images/login.png"><span>ADMIN</span></a>
					   <a href="login/admin_login.php" id="loginButton"><img src="images/login.png"><span>SUPER ADMIN</span></a> <br><br>
						    <div id="loginBox" style="background-color:lightgreen">                
						          <a href="login/user_login.php" id="loginButton"><img src="images/login.png"><span>LOGINN</span></a>
								   <a href="login/user_login_signup.php" id="loginButton"><img src="images/login.png"><span>SIGNUP</span></a>
								    <a href="login/admin_login.php" id="loginButton"><img src="images/login.png"><span>ADMIN</span></a>
								   <a href="login/admin_login.php" id="loginButton"><img src="images/login.png"><span>SUPER ADMIN</span></a>
				              </div>
			             </div>
		                 <div class="clearfix"></div>
	                 </div>
