...
<title>Brands | Rooms :: w3layouts</title>
...
<div class="header">
   ...
   <div class="living_middle">
	  ...
	  <!------------------------------------------------------------------------------------------->
 <p style="color:green; "><?php echo "Welcome   ".$_SESSION["USER"];  ?> 	  </p>
 <p style="color:green; "> <?php //echo "Code   ".$_SESSION["USERID"];  ?> 	  
		...
		<div class ="col-sm-6">	
			...
			<label class="control-label col-sm-4">Brands ID</label>
			<div class="col-sm-8">
			<input type ="text" class="form-control" id ="bid" name ="bid" placeholder ="Enter brands  id..." /><br/>
			</div>
			</div>
			...
			<div class="form-group">
			<label class="control-label col-sm-4">Brands Name</label>
			<div class="col-sm-8">
			<input type ="text" class="form-control" name="brands"   id = "brands" placeholder ="Enter brands..."></textarea><br />	
			</div>
			</div>
			...
			<div class="form-group">		
			<label class="control-label col-sm-4">Brands Image</label> 
			<div class="col-sm-8">
...
$sql = "INSERT INTO brands (BID,Brands,Images) Values ( '$pid','$brands','$imagess')";
