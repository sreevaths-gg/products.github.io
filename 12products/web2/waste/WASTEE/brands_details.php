...
<title>HBrands | Rooms :: w3layouts</title>
...
<div class="header">
 ...
 <p style="color:green; "> <?php //echo "Code   ".$_SESSION["USERID"];  ?> 	  
  ...
  <table class="table table-striped table-bordered"> 
   <thead>
	<th >SN</th><th>Brand Id</th><th >Brand Name</th><th>Images</th><th> Delete</th>
		</thead>
   <?php
...
<td><?php echo $bid;?></td><td><b><?php echo $b;?></b></td>
<td>  <img src="brands/<?php echo $images;?>" class="img-responsive" alt="" width="300px"/></td>
<td><a href="delete.php?sid=<?php echo $i;?>&a=2">REMOVE</a></td>
