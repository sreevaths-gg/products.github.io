	  ...
	  <div class ="col-sm-2">
		<div class ="vertical_tabs">
				<ul class="nav nav-tabs nav-stacked" style="background-color:lightyellow">
						...
						<li class="active"><a href="checkout_form.php">Checkout</a></li>
...
$j=1;$pn=null;$b=null;$pc =null;$T=null;
$n=null;$uid=null;$o=null;
$upass=0;$uname=0;$status=0;$ucode;
foreach($_SESSION["cartarray"] as $key => $value) 
{
	//echo $key;		
	foreach($value as $key1 => $value1) 	
	{
if ($key1=='Product_Name') {$pn =$value1." + ".$pn; }
if ($key1=='Product_Code')  {$pc=$value1." + ".$pc;}
if ($key1=='Brands')  {$b=$value1." + ".$b;}
if ($key1=='TotalPrice')	{$T=$value1 + $T;}
	}
}
//echo $pn;//echo $pn;
//echo $pc;
...
?>
		...
		<div class ="col-sm-6">	
			...
			<div class="col-sm-8">
			<input type ="text" class="form-control" id ="pcode" name ="pcode" value="<?php echo $o; ?>" placeholder ="Enter Order code..." /><br/>
			</div>
			</div>
			
			<div class="form-group">				
			<label class="control-label col-sm-4">Ordered Code</label>
			<div class="col-sm-8">
			<input type ="text" class="form-control" id ="pid" name ="pid" value="<?php echo $pc; ?>" placeholder ="Enter ordered code..." /><br/>
			</div>
			</div>
			
			<div class="form-group">			
			<label class="control-label col-sm-4">Ordered Name</label> 
			<div class="col-sm-8">
			<input type ="text" class="form-control" id ="pname" name ="pname"  value="<?php echo $pn; ?>"  placeholder ="Enter ordered name..."/><br/>
			</div>
			</div>
						
			<div class="form-group">
			<label class="control-label col-sm-4">Ordered Brands</label>
			<div class="col-sm-8">
			<input type ="text" class="form-control" name="brands"   id = "brands" value="<?php echo $b; ?>" placeholder ="Enter ordered brands..."><br />	
			</div>
			</div>
						
			<div class="form-group">
			<label class="control-label col-sm-4">Ordered Price</label>
			<div class="col-sm-8">
			<input type ="text" class="form-control" name="price"   id = "price" value="<?php echo $T; ?>" placeholder ="Enter ordered price..."><br />	
			</div>
			</div>
			<div class="form-group">
			<label class="control-label col-sm-4">User Name </label> 
			<div class="col-sm-8">
			<input type="text" name="uname" class="form-control"  id = "uname" value="<?php echo $uname; ?>" placeholder ="Enter user name ..."><br />	
			</div>
			</div>
			
			<div class="form-group">
			<label class="control-label col-sm-4">User Code </label> 
			<div class="col-sm-8">
			<input type="text" name="ucode" class="form-control"  id = "ucode" value="<?php echo $ucode; ?>" placeholder ="Enter user name ..."><br />	
			</div>
			</div>
...
$sql = "INSERT INTO orders (ORDER_CODE, ORDER_CODES,ORDER_ITEMS,ORDER_BRANDS,ORDER_PRICE,UNAME,UID) Values ('$pcode', '$pid','$pn','$b','$price','$uname','$ucode')";
